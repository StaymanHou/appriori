 ...
 */
	public void generate(HashMap<char[], Integer> rawData, HashMap<char[], Integer> entry){
	...
	private void writeexcelfile(List<Rule> ruleList) {
		...
		try {
		    FileOutputStream out =
		            new FileOutputStream(new File("AssociationRules.xls"));
		    workbook.write(out);
		    out.close();
